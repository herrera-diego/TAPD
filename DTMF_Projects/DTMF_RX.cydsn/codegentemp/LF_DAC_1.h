...
#define LF_DAC_1_WAVE2_TYPE     (11u)     /* Waveform for wave2 */
...
#define LF_DAC_1_WAVE1_LENGTH   (200u)   /* Length for wave1 */
#define LF_DAC_1_WAVE2_LENGTH   (4u)   /* Length for wave2 */
