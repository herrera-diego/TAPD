// ======================================================================
// DTMF_RX.v generated from TopDesign.cysch
// 03/04/2018 at 22:03
...
module top ;
	...
	cy_clock_v1_0
		#(.id("988a0456-18a8-4935-8c98-71438b2a7501"),
		  .source_clock_id("61737EF6-3B74-48f9-8B91-F7473A442AE7"),
		  .divisor(533),
		  .period("0"),
		  .is_direct(0),
	...
	cy_clock_v1_0
		#(.id("2d4e65c0-f180-4e18-8d22-7d1e0145423b"),
		  .source_clock_id("61737EF6-3B74-48f9-8B91-F7473A442AE7"),
		  .divisor(533),
		  .period("0"),
		  .is_direct(0),
	...
	wire [0:0] tmpOE__TX_Output_net;
	wire [0:0] tmpFB_0__TX_Output_net;
	wire [0:0] tmpIO_0__TX_Output_net;
	wire [0:0] tmpINTERRUPT_0__TX_Output_net;
	electrical [0:0] tmpSIOVREF__TX_Output_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("77715107-f8d5-47e5-a629-0fb83101ac6b"),
		  ...
		  .input_buffer_sel(2'b00))
		TX_Output
		 (.oe(tmpOE__TX_Output_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__TX_Output_net[0:0]}),
		  .analog({Net_153}),
		  .io({tmpIO_0__TX_Output_net[0:0]}),
		  .siovref(tmpSIOVREF__TX_Output_net),
		  .interrupt({tmpINTERRUPT_0__TX_Output_net[0:0]}),
		  .annotation({Net_205}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
	...
	assign tmpOE__TX_Output_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__RX_Input_Pos_net;
	wire [0:0] tmpFB_0__RX_Input_Pos_net;
	wire [0:0] tmpIO_0__RX_Input_Pos_net;
	wire [0:0] tmpINTERRUPT_0__RX_Input_Pos_net;
	electrical [0:0] tmpSIOVREF__RX_Input_Pos_net;

	cy_psoc3_pins_v1_10
		#(.id("2ae4f889-72ca-4f92-8e6f-7fed61926cce"),
		  .drive_mode(3'b000),
		  .ibuf_enabled(1'b0),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		RX_Input_Pos
		 (.oe(tmpOE__RX_Input_Pos_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__RX_Input_Pos_net[0:0]}),
		  .analog({Net_231}),
		  .io({tmpIO_0__RX_Input_Pos_net[0:0]}),
		  .siovref(tmpSIOVREF__RX_Input_Pos_net),
		  .interrupt({tmpINTERRUPT_0__RX_Input_Pos_net[0:0]}),
		  .annotation({Net_226}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
	...
	assign tmpOE__RX_Input_Pos_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__RX_Input_Neg_net;
	wire [0:0] tmpFB_0__RX_Input_Neg_net;
	wire [0:0] tmpIO_0__RX_Input_Neg_net;
	wire [0:0] tmpINTERRUPT_0__RX_Input_Neg_net;
	electrical [0:0] tmpSIOVREF__RX_Input_Neg_net;

	cy_psoc3_pins_v1_10
		#(.id("487358c7-b916-4f57-a190-7ed2f52f208c"),
		  .drive_mode(3'b000),
		  .ibuf_enabled(1'b0),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		RX_Input_Neg
		 (.oe(tmpOE__RX_Input_Neg_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__RX_Input_Neg_net[0:0]}),
		  .analog({Net_137}),
		  .io({tmpIO_0__RX_Input_Neg_net[0:0]}),
		  .siovref(tmpSIOVREF__RX_Input_Neg_net),
		  .interrupt({tmpINTERRUPT_0__RX_Input_Neg_net[0:0]}),
		  .annotation({Net_228}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
	...
	assign tmpOE__RX_Input_Neg_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
