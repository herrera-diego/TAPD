...
*/
     ...
     * \brief Constants to be passed as "mode" parameter in the RX_Input_SetDriveMode() function.
     *  @{
     */
...
/* Interrupt constants */
#if defined(RX_Input__INTSTAT)
/**
* \addtogroup group_constants
* @{
*/
    /** \addtogroup intrMode Interrupt constants
     * \brief Constants to be passed as "mode" parameter in RX_Input_SetInterruptMode() function.
     *  @{
     */
        #define RX_Input_INTR_NONE      (uint16)(0x0000u)
        #define RX_Input_INTR_RISING    (uint16)(0x0001u)
        #define RX_Input_INTR_FALLING   (uint16)(0x0002u)
        #define RX_Input_INTR_BOTH      (uint16)(0x0003u) 
    /** @} intrMode */
/** @} group_constants */

    #define RX_Input_INTR_MASK      (0x01u) 
#endif /* (RX_Input__INTSTAT) */
...
/* SIO registers */
#if defined(RX_Input__SIO_CFG)
    #define RX_Input_SIO_HYST_EN        (* (reg8 *) RX_Input__SIO_HYST_EN)
    #define RX_Input_SIO_REG_HIFREQ     (* (reg8 *) RX_Input__SIO_REG_HIFREQ)
    #define RX_Input_SIO_CFG            (* (reg8 *) RX_Input__SIO_CFG)
    #define RX_Input_SIO_DIFF           (* (reg8 *) RX_Input__SIO_DIFF)
#endif /* (RX_Input__SIO_CFG) */
...
/* Interrupt Registers */
	...
	#define RX_Input_0_INTTYPE_REG 		(* (reg8 *) RX_Input__0__INTTYPE)
#endif /* (RX_Input__INTSTAT) */
