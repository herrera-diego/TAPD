...
void HighFrequencies_2_Init(void) 
{
	...
	HighFrequencies_2_VDAC8_SetSpeed(HighFrequencies_2_HIGHSPEED);
	HighFrequencies_2_VDAC8_SetRange(HighFrequencies_2_DAC_RANGE);

	#if(HighFrequencies_2_DAC_MODE == HighFrequencies_2_CURRENT_MODE)
		HighFrequencies_2_IDAC8_SetPolarity(HighFrequencies_2_DAC_POL);
	#endif /* HighFrequencies_2_DAC_MODE == HighFrequencies_2_CURRENT_MODE */

	#if(HighFrequencies_2_OUT_MODE == HighFrequencies_2_BUFFER_MODE)
	   HighFrequencies_2_BuffAmp_Init();
	#endif /* HighFrequencies_2_OUT_MODE == HighFrequencies_2_BUFFER_MODE */

	/* Get the TD Number for the DMA channel 1 and 2   */
	HighFrequencies_2_Wave1TD = CyDmaTdAllocate();
	HighFrequencies_2_Wave2TD = CyDmaTdAllocate();
	
	/* Initialize waveform pointers  */
	HighFrequencies_2_Wave1Setup(HighFrequencies_2_wave1, HighFrequencies_2_WAVE1_LENGTH) ;
	HighFrequencies_2_Wave2Setup(HighFrequencies_2_wave2, HighFrequencies_2_WAVE2_LENGTH) ;
	
	/* Initialize the internal clock if one present  */
	#if defined(HighFrequencies_2_DacClk_PHASE)
	   HighFrequencies_2_DacClk_SetPhase(HighFrequencies_2_CLK_PHASE_0nS);
	#endif /* defined(HighFrequencies_2_DacClk_PHASE) */
}


/*******************************************************************************
* Function Name: HighFrequencies_2_Enable
********************************************************************************
*  
* Summary: 
...
void HighFrequencies_2_Enable(void) 
{
	...
	#if(HighFrequencies_2_OUT_MODE == HighFrequencies_2_BUFFER_MODE)
	   HighFrequencies_2_BuffAmp_Enable();
	#endif /* HighFrequencies_2_OUT_MODE == HighFrequencies_2_BUFFER_MODE */
	...
	*/
	(void)CyDmaChEnable(HighFrequencies_2_Wave1Chan, 1u);
	(void)CyDmaChEnable(HighFrequencies_2_Wave2Chan, 1u);
	
	/* set the initial value */
	HighFrequencies_2_SetValue(0u);
	
	#if(HighFrequencies_2_CLOCK_SRC == HighFrequencies_2_CLOCK_INT)  	
	   HighFrequencies_2_DacClk_Start();
	#endif /* HighFrequencies_2_CLOCK_SRC == HighFrequencies_2_CLOCK_INT */
}


/*******************************************************************************
* Function Name: HighFrequencies_2_Start
********************************************************************************
*
* Summary:
...
void HighFrequencies_2_Start(void) 
{
	...
	if(HighFrequencies_2_initVar == 0u)
	{
		HighFrequencies_2_Init();
		HighFrequencies_2_initVar = 1u;
	}
...
/*******************************************************************************
* Function Name: HighFrequencies_2_StartEx
********************************************************************************
*
* Summary:
...
{
	HighFrequencies_2_Wave1Setup(wavePtr1, sampleSize1);
	HighFrequencies_2_Wave2Setup(wavePtr2, sampleSize2);
	HighFrequencies_2_Start();
}


/*******************************************************************************
* Function Name: HighFrequencies_2_Stop
********************************************************************************
*
* Summary:
...
void HighFrequencies_2_Stop(void) 
{
	...
	#if(HighFrequencies_2_CLOCK_SRC == HighFrequencies_2_CLOCK_INT)  	
	   HighFrequencies_2_DacClk_Stop();
	#endif /* HighFrequencies_2_CLOCK_SRC == HighFrequencies_2_CLOCK_INT */
	
	/* Disble DMA channels */
	(void)CyDmaChDisable(HighFrequencies_2_Wave1Chan);
	(void)CyDmaChDisable(HighFrequencies_2_Wave2Chan);
...
/*******************************************************************************
* Function Name: HighFrequencies_2_Wave1Setup
********************************************************************************
*
* Summary:
...

{
		...
		memoryType = (HighFrequencies_2_HI16FLASHPTR == HI16(wavePtr)) ? HI16(CYDEV_FLS_BASE) : HI16(CYDEV_SRAM_BASE);
		
		HighFrequencies_2_Wave1Chan = HighFrequencies_2_Wave1_DMA_DmaInitialize(
		HighFrequencies_2_Wave1_DMA_BYTES_PER_BURST, HighFrequencies_2_Wave1_DMA_REQUEST_PER_BURST,
		memoryType, HI16(CYDEV_PERIPH_BASE));
	#else /* PSoC 5 */
		HighFrequencies_2_Wave1Chan = HighFrequencies_2_Wave1_DMA_DmaInitialize(
		HighFrequencies_2_Wave1_DMA_BYTES_PER_BURST, HighFrequencies_2_Wave1_DMA_REQUEST_PER_BURST,
		HI16(wavePtr), HI16(HighFrequencies_2_DAC8__D));
	#endif /* CY_PSOC3 */
	...
	*/
	(void)CyDmaTdSetConfiguration(HighFrequencies_2_Wave1TD, sampleSize, HighFrequencies_2_Wave1TD, 
                                    (uint8)CY_DMA_TD_INC_SRC_ADR | (uint8)HighFrequencies_2_Wave1_DMA__TD_TERMOUT_EN); 
	
	/* Set the TD source and destination address */
	(void)CyDmaTdSetAddress(HighFrequencies_2_Wave1TD, LO16((uint32)wavePtr), LO16(HighFrequencies_2_DAC8__D));
	
	/* Associate the TD with the channel */
	(void)CyDmaChSetInitialTd(HighFrequencies_2_Wave1Chan, HighFrequencies_2_Wave1TD);
}


/*******************************************************************************
* Function Name: HighFrequencies_2_Wave2Setup
********************************************************************************
*
* Summary:
 ...
 
{
		...
		HighFrequencies_2_Wave2Chan = HighFrequencies_2_Wave2_DMA_DmaInitialize(
		HighFrequencies_2_Wave2_DMA_BYTES_PER_BURST, HighFrequencies_2_Wave2_DMA_REQUEST_PER_BURST,
		memoryType, HI16(CYDEV_PERIPH_BASE));
	#else /* PSoC 5 */
		HighFrequencies_2_Wave2Chan = HighFrequencies_2_Wave2_DMA_DmaInitialize(
		HighFrequencies_2_Wave2_DMA_BYTES_PER_BURST, HighFrequencies_2_Wave2_DMA_REQUEST_PER_BURST,
	...
	* Increment the source address, but not the destination address. 
	*/
	(void)CyDmaTdSetConfiguration(HighFrequencies_2_Wave2TD, sampleSize, HighFrequencies_2_Wave2TD, 
                                    (uint8)CY_DMA_TD_INC_SRC_ADR | (uint8)HighFrequencies_2_Wave2_DMA__TD_TERMOUT_EN); 
	
	/* Set the TD source and destination address */
	(void)CyDmaTdSetAddress(HighFrequencies_2_Wave2TD, LO16((uint32)wavePtr), LO16(HighFrequencies_2_DAC8__D));
	
	/* Associate the TD with the channel */
	(void)CyDmaChSetInitialTd(HighFrequencies_2_Wave2Chan, HighFrequencies_2_Wave2TD);
}
