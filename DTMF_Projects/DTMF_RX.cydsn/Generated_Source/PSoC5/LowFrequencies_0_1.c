/*******************************************************************************
* File Name: LowFrequencies_0_1.c
* Version 2.10
*
* Description:
...
{
	LowFrequencies_0_1_VDAC8_Init();
	LowFrequencies_0_1_VDAC8_SetSpeed(LowFrequencies_0_1_HIGHSPEED);
	LowFrequencies_0_1_VDAC8_SetRange(LowFrequencies_0_1_DAC_RANGE);

	#if(LowFrequencies_0_1_DAC_MODE == LowFrequencies_0_1_CURRENT_MODE)
		LowFrequencies_0_1_IDAC8_SetPolarity(LowFrequencies_0_1_DAC_POL);
	#endif /* LowFrequencies_0_1_DAC_MODE == LowFrequencies_0_1_CURRENT_MODE */

	#if(LowFrequencies_0_1_OUT_MODE == LowFrequencies_0_1_BUFFER_MODE)
	   LowFrequencies_0_1_BuffAmp_Init();
	#endif /* LowFrequencies_0_1_OUT_MODE == LowFrequencies_0_1_BUFFER_MODE */

	/* Get the TD Number for the DMA channel 1 and 2   */
	LowFrequencies_0_1_Wave1TD = CyDmaTdAllocate();
	LowFrequencies_0_1_Wave2TD = CyDmaTdAllocate();
	
	/* Initialize waveform pointers  */
	LowFrequencies_0_1_Wave1Setup(LowFrequencies_0_1_wave1, LowFrequencies_0_1_WAVE1_LENGTH) ;
	LowFrequencies_0_1_Wave2Setup(LowFrequencies_0_1_wave2, LowFrequencies_0_1_WAVE2_LENGTH) ;
	
	/* Initialize the internal clock if one present  */
	#if defined(LowFrequencies_0_1_DacClk_PHASE)
	   LowFrequencies_0_1_DacClk_SetPhase(LowFrequencies_0_1_CLK_PHASE_0nS);
	#endif /* defined(LowFrequencies_0_1_DacClk_PHASE) */
}


/*******************************************************************************
* Function Name: LowFrequencies_0_1_Enable
********************************************************************************
*  
* Summary: 
...
{
	LowFrequencies_0_1_VDAC8_Enable();

	#if(LowFrequencies_0_1_OUT_MODE == LowFrequencies_0_1_BUFFER_MODE)
	   LowFrequencies_0_1_BuffAmp_Enable();
	#endif /* LowFrequencies_0_1_OUT_MODE == LowFrequencies_0_1_BUFFER_MODE */
	...
	*/
	(void)CyDmaChEnable(LowFrequencies_0_1_Wave1Chan, 1u);
	(void)CyDmaChEnable(LowFrequencies_0_1_Wave2Chan, 1u);
	
	/* set the initial value */
	LowFrequencies_0_1_SetValue(0u);
	
	#if(LowFrequencies_0_1_CLOCK_SRC == LowFrequencies_0_1_CLOCK_INT)  	
	   LowFrequencies_0_1_DacClk_Start();
	#endif /* LowFrequencies_0_1_CLOCK_SRC == LowFrequencies_0_1_CLOCK_INT */
}


/*******************************************************************************
* Function Name: LowFrequencies_0_1_Start
********************************************************************************
*
* Summary:
...
void LowFrequencies_0_1_Start(void) 
{
	...
	if(LowFrequencies_0_1_initVar == 0u)
	{
		LowFrequencies_0_1_Init();
		LowFrequencies_0_1_initVar = 1u;
	}
...
/*******************************************************************************
* Function Name: LowFrequencies_0_1_StartEx
********************************************************************************
*
* Summary:
...
{
	LowFrequencies_0_1_Wave1Setup(wavePtr1, sampleSize1);
	LowFrequencies_0_1_Wave2Setup(wavePtr2, sampleSize2);
	LowFrequencies_0_1_Start();
}


/*******************************************************************************
* Function Name: LowFrequencies_0_1_Stop
********************************************************************************
*
* Summary:
...
void LowFrequencies_0_1_Stop(void) 
{
	...
	#if(LowFrequencies_0_1_CLOCK_SRC == LowFrequencies_0_1_CLOCK_INT)  	
	   LowFrequencies_0_1_DacClk_Stop();
	#endif /* LowFrequencies_0_1_CLOCK_SRC == LowFrequencies_0_1_CLOCK_INT */
	
	/* Disble DMA channels */
	(void)CyDmaChDisable(LowFrequencies_0_1_Wave1Chan);
	(void)CyDmaChDisable(LowFrequencies_0_1_Wave2Chan);

	/* Disable power to DAC */
	LowFrequencies_0_1_VDAC8_Stop();
}


/*******************************************************************************
* Function Name: LowFrequencies_0_1_Wave1Setup
********************************************************************************
*
* Summary:
...

{
		...
		memoryType = (LowFrequencies_0_1_HI16FLASHPTR == HI16(wavePtr)) ? HI16(CYDEV_FLS_BASE) : HI16(CYDEV_SRAM_BASE);
		
		LowFrequencies_0_1_Wave1Chan = LowFrequencies_0_1_Wave1_DMA_DmaInitialize(
		LowFrequencies_0_1_Wave1_DMA_BYTES_PER_BURST, LowFrequencies_0_1_Wave1_DMA_REQUEST_PER_BURST,
		memoryType, HI16(CYDEV_PERIPH_BASE));
	#else /* PSoC 5 */
		LowFrequencies_0_1_Wave1Chan = LowFrequencies_0_1_Wave1_DMA_DmaInitialize(
		LowFrequencies_0_1_Wave1_DMA_BYTES_PER_BURST, LowFrequencies_0_1_Wave1_DMA_REQUEST_PER_BURST,
		HI16(wavePtr), HI16(LowFrequencies_0_1_DAC8__D));
	#endif /* CY_PSOC3 */
	...
	*/
	(void)CyDmaTdSetConfiguration(LowFrequencies_0_1_Wave1TD, sampleSize, LowFrequencies_0_1_Wave1TD, 
                                    (uint8)CY_DMA_TD_INC_SRC_ADR | (uint8)LowFrequencies_0_1_Wave1_DMA__TD_TERMOUT_EN); 
	
	/* Set the TD source and destination address */
	(void)CyDmaTdSetAddress(LowFrequencies_0_1_Wave1TD, LO16((uint32)wavePtr), LO16(LowFrequencies_0_1_DAC8__D));
	
	/* Associate the TD with the channel */
	(void)CyDmaChSetInitialTd(LowFrequencies_0_1_Wave1Chan, LowFrequencies_0_1_Wave1TD);
}


/*******************************************************************************
* Function Name: LowFrequencies_0_1_Wave2Setup
********************************************************************************
*
* Summary:
 ...
 
{
		...
		LowFrequencies_0_1_Wave2Chan = LowFrequencies_0_1_Wave2_DMA_DmaInitialize(
		LowFrequencies_0_1_Wave2_DMA_BYTES_PER_BURST, LowFrequencies_0_1_Wave2_DMA_REQUEST_PER_BURST,
		memoryType, HI16(CYDEV_PERIPH_BASE));
	#else /* PSoC 5 */
		LowFrequencies_0_1_Wave2Chan = LowFrequencies_0_1_Wave2_DMA_DmaInitialize(
		LowFrequencies_0_1_Wave2_DMA_BYTES_PER_BURST, LowFrequencies_0_1_Wave2_DMA_REQUEST_PER_BURST,
	...
	* Increment the source address, but not the destination address. 
	*/
	(void)CyDmaTdSetConfiguration(LowFrequencies_0_1_Wave2TD, sampleSize, LowFrequencies_0_1_Wave2TD, 
                                    (uint8)CY_DMA_TD_INC_SRC_ADR | (uint8)LowFrequencies_0_1_Wave2_DMA__TD_TERMOUT_EN); 
	
	/* Set the TD source and destination address */
	(void)CyDmaTdSetAddress(LowFrequencies_0_1_Wave2TD, LO16((uint32)wavePtr), LO16(LowFrequencies_0_1_DAC8__D));
	
	/* Associate the TD with the channel */
	(void)CyDmaChSetInitialTd(LowFrequencies_0_1_Wave2Chan, LowFrequencies_0_1_Wave2TD);
}
