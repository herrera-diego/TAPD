...
#define HF_DAC_1_WAVE2_TYPE     (11u)     /* Waveform for wave2 */
...
#define HF_DAC_1_WAVE1_LENGTH   (300u)   /* Length for wave1 */
#define HF_DAC_1_WAVE2_LENGTH   (4u)   /* Length for wave2 */
