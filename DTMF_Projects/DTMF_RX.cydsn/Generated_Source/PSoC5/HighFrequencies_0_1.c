/*******************************************************************************
* File Name: HighFrequencies_0_1.c
* Version 2.10
*
* Description:
...
void HighFrequencies_0_1_Init(void) 
{
	...
	HighFrequencies_0_1_VDAC8_SetSpeed(HighFrequencies_0_1_HIGHSPEED);
	HighFrequencies_0_1_VDAC8_SetRange(HighFrequencies_0_1_DAC_RANGE);

	#if(HighFrequencies_0_1_DAC_MODE == HighFrequencies_0_1_CURRENT_MODE)
		HighFrequencies_0_1_IDAC8_SetPolarity(HighFrequencies_0_1_DAC_POL);
	#endif /* HighFrequencies_0_1_DAC_MODE == HighFrequencies_0_1_CURRENT_MODE */

	#if(HighFrequencies_0_1_OUT_MODE == HighFrequencies_0_1_BUFFER_MODE)
	   HighFrequencies_0_1_BuffAmp_Init();
	#endif /* HighFrequencies_0_1_OUT_MODE == HighFrequencies_0_1_BUFFER_MODE */

	/* Get the TD Number for the DMA channel 1 and 2   */
	HighFrequencies_0_1_Wave1TD = CyDmaTdAllocate();
	HighFrequencies_0_1_Wave2TD = CyDmaTdAllocate();
	
	/* Initialize waveform pointers  */
	HighFrequencies_0_1_Wave1Setup(HighFrequencies_0_1_wave1, HighFrequencies_0_1_WAVE1_LENGTH) ;
	HighFrequencies_0_1_Wave2Setup(HighFrequencies_0_1_wave2, HighFrequencies_0_1_WAVE2_LENGTH) ;
	
	/* Initialize the internal clock if one present  */
	#if defined(HighFrequencies_0_1_DacClk_PHASE)
	   HighFrequencies_0_1_DacClk_SetPhase(HighFrequencies_0_1_CLK_PHASE_0nS);
	#endif /* defined(HighFrequencies_0_1_DacClk_PHASE) */
}


/*******************************************************************************
* Function Name: HighFrequencies_0_1_Enable
********************************************************************************
*  
* Summary: 
...
void HighFrequencies_0_1_Enable(void) 
{
	...
	#if(HighFrequencies_0_1_OUT_MODE == HighFrequencies_0_1_BUFFER_MODE)
	   HighFrequencies_0_1_BuffAmp_Enable();
	#endif /* HighFrequencies_0_1_OUT_MODE == HighFrequencies_0_1_BUFFER_MODE */
	...
	*/
	(void)CyDmaChEnable(HighFrequencies_0_1_Wave1Chan, 1u);
	(void)CyDmaChEnable(HighFrequencies_0_1_Wave2Chan, 1u);
	
	/* set the initial value */
	HighFrequencies_0_1_SetValue(0u);
	
	#if(HighFrequencies_0_1_CLOCK_SRC == HighFrequencies_0_1_CLOCK_INT)  	
	   HighFrequencies_0_1_DacClk_Start();
	#endif /* HighFrequencies_0_1_CLOCK_SRC == HighFrequencies_0_1_CLOCK_INT */
}


/*******************************************************************************
* Function Name: HighFrequencies_0_1_Start
********************************************************************************
*
* Summary:
...
void HighFrequencies_0_1_Start(void) 
{
	...
	if(HighFrequencies_0_1_initVar == 0u)
	{
		HighFrequencies_0_1_Init();
		HighFrequencies_0_1_initVar = 1u;
	}
...
/*******************************************************************************
* Function Name: HighFrequencies_0_1_StartEx
********************************************************************************
*
* Summary:
...
{
	HighFrequencies_0_1_Wave1Setup(wavePtr1, sampleSize1);
	HighFrequencies_0_1_Wave2Setup(wavePtr2, sampleSize2);
	HighFrequencies_0_1_Start();
}


/*******************************************************************************
* Function Name: HighFrequencies_0_1_Stop
********************************************************************************
*
* Summary:
...
void HighFrequencies_0_1_Stop(void) 
{
	...
	#if(HighFrequencies_0_1_CLOCK_SRC == HighFrequencies_0_1_CLOCK_INT)  	
	   HighFrequencies_0_1_DacClk_Stop();
	#endif /* HighFrequencies_0_1_CLOCK_SRC == HighFrequencies_0_1_CLOCK_INT */
	
	/* Disble DMA channels */
	(void)CyDmaChDisable(HighFrequencies_0_1_Wave1Chan);
	(void)CyDmaChDisable(HighFrequencies_0_1_Wave2Chan);

	/* Disable power to DAC */
	HighFrequencies_0_1_VDAC8_Stop();
}


/*******************************************************************************
* Function Name: HighFrequencies_0_1_Wave1Setup
********************************************************************************
*
* Summary:
...

{
		...
		memoryType = (HighFrequencies_0_1_HI16FLASHPTR == HI16(wavePtr)) ? HI16(CYDEV_FLS_BASE) : HI16(CYDEV_SRAM_BASE);
		
		HighFrequencies_0_1_Wave1Chan = HighFrequencies_0_1_Wave1_DMA_DmaInitialize(
		HighFrequencies_0_1_Wave1_DMA_BYTES_PER_BURST, HighFrequencies_0_1_Wave1_DMA_REQUEST_PER_BURST,
		memoryType, HI16(CYDEV_PERIPH_BASE));
	#else /* PSoC 5 */
		HighFrequencies_0_1_Wave1Chan = HighFrequencies_0_1_Wave1_DMA_DmaInitialize(
		HighFrequencies_0_1_Wave1_DMA_BYTES_PER_BURST, HighFrequencies_0_1_Wave1_DMA_REQUEST_PER_BURST,
		HI16(wavePtr), HI16(HighFrequencies_0_1_DAC8__D));
	#endif /* CY_PSOC3 */
	...
	*/
	(void)CyDmaTdSetConfiguration(HighFrequencies_0_1_Wave1TD, sampleSize, HighFrequencies_0_1_Wave1TD, 
                                    (uint8)CY_DMA_TD_INC_SRC_ADR | (uint8)HighFrequencies_0_1_Wave1_DMA__TD_TERMOUT_EN); 
	
	/* Set the TD source and destination address */
	(void)CyDmaTdSetAddress(HighFrequencies_0_1_Wave1TD, LO16((uint32)wavePtr), LO16(HighFrequencies_0_1_DAC8__D));
	
	/* Associate the TD with the channel */
	(void)CyDmaChSetInitialTd(HighFrequencies_0_1_Wave1Chan, HighFrequencies_0_1_Wave1TD);
}


/*******************************************************************************
* Function Name: HighFrequencies_0_1_Wave2Setup
********************************************************************************
*
* Summary:
 ...
 
{
		...
		HighFrequencies_0_1_Wave2Chan = HighFrequencies_0_1_Wave2_DMA_DmaInitialize(
		HighFrequencies_0_1_Wave2_DMA_BYTES_PER_BURST, HighFrequencies_0_1_Wave2_DMA_REQUEST_PER_BURST,
		memoryType, HI16(CYDEV_PERIPH_BASE));
	#else /* PSoC 5 */
		HighFrequencies_0_1_Wave2Chan = HighFrequencies_0_1_Wave2_DMA_DmaInitialize(
		HighFrequencies_0_1_Wave2_DMA_BYTES_PER_BURST, HighFrequencies_0_1_Wave2_DMA_REQUEST_PER_BURST,
	...
	* Increment the source address, but not the destination address. 
	*/
	(void)CyDmaTdSetConfiguration(HighFrequencies_0_1_Wave2TD, sampleSize, HighFrequencies_0_1_Wave2TD, 
                                    (uint8)CY_DMA_TD_INC_SRC_ADR | (uint8)HighFrequencies_0_1_Wave2_DMA__TD_TERMOUT_EN); 
	
	/* Set the TD source and destination address */
	(void)CyDmaTdSetAddress(HighFrequencies_0_1_Wave2TD, LO16((uint32)wavePtr), LO16(HighFrequencies_0_1_DAC8__D));
	
	/* Associate the TD with the channel */
	(void)CyDmaChSetInitialTd(HighFrequencies_0_1_Wave2Chan, HighFrequencies_0_1_Wave2TD);
}
