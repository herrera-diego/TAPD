/*******************************************************************************
* File Name: LowFrequencies_2_3.c
* Version 2.10
*
* Description:
...
{
	LowFrequencies_2_3_VDAC8_Init();
	LowFrequencies_2_3_VDAC8_SetSpeed(LowFrequencies_2_3_HIGHSPEED);
	LowFrequencies_2_3_VDAC8_SetRange(LowFrequencies_2_3_DAC_RANGE);

	#if(LowFrequencies_2_3_DAC_MODE == LowFrequencies_2_3_CURRENT_MODE)
		LowFrequencies_2_3_IDAC8_SetPolarity(LowFrequencies_2_3_DAC_POL);
	#endif /* LowFrequencies_2_3_DAC_MODE == LowFrequencies_2_3_CURRENT_MODE */

	#if(LowFrequencies_2_3_OUT_MODE == LowFrequencies_2_3_BUFFER_MODE)
	   LowFrequencies_2_3_BuffAmp_Init();
	#endif /* LowFrequencies_2_3_OUT_MODE == LowFrequencies_2_3_BUFFER_MODE */

	/* Get the TD Number for the DMA channel 1 and 2   */
	LowFrequencies_2_3_Wave1TD = CyDmaTdAllocate();
	LowFrequencies_2_3_Wave2TD = CyDmaTdAllocate();
	
	/* Initialize waveform pointers  */
	LowFrequencies_2_3_Wave1Setup(LowFrequencies_2_3_wave1, LowFrequencies_2_3_WAVE1_LENGTH) ;
	LowFrequencies_2_3_Wave2Setup(LowFrequencies_2_3_wave2, LowFrequencies_2_3_WAVE2_LENGTH) ;
	
	/* Initialize the internal clock if one present  */
	#if defined(LowFrequencies_2_3_DacClk_PHASE)
	   LowFrequencies_2_3_DacClk_SetPhase(LowFrequencies_2_3_CLK_PHASE_0nS);
	#endif /* defined(LowFrequencies_2_3_DacClk_PHASE) */
}


/*******************************************************************************
* Function Name: LowFrequencies_2_3_Enable
********************************************************************************
*  
* Summary: 
...
void LowFrequencies_2_3_Enable(void) 
{
	...
	#if(LowFrequencies_2_3_OUT_MODE == LowFrequencies_2_3_BUFFER_MODE)
	   LowFrequencies_2_3_BuffAmp_Enable();
	#endif /* LowFrequencies_2_3_OUT_MODE == LowFrequencies_2_3_BUFFER_MODE */
	...
	*/
	(void)CyDmaChEnable(LowFrequencies_2_3_Wave1Chan, 1u);
	(void)CyDmaChEnable(LowFrequencies_2_3_Wave2Chan, 1u);
	
	/* set the initial value */
	LowFrequencies_2_3_SetValue(0u);
	
	#if(LowFrequencies_2_3_CLOCK_SRC == LowFrequencies_2_3_CLOCK_INT)  	
	   LowFrequencies_2_3_DacClk_Start();
	#endif /* LowFrequencies_2_3_CLOCK_SRC == LowFrequencies_2_3_CLOCK_INT */
}


/*******************************************************************************
* Function Name: LowFrequencies_2_3_Start
********************************************************************************
*
* Summary:
...
void LowFrequencies_2_3_Start(void) 
{
	...
	if(LowFrequencies_2_3_initVar == 0u)
	{
		LowFrequencies_2_3_Init();
		LowFrequencies_2_3_initVar = 1u;
	}
...
/*******************************************************************************
* Function Name: LowFrequencies_2_3_StartEx
********************************************************************************
*
* Summary:
...
{
	LowFrequencies_2_3_Wave1Setup(wavePtr1, sampleSize1);
	LowFrequencies_2_3_Wave2Setup(wavePtr2, sampleSize2);
	LowFrequencies_2_3_Start();
}


/*******************************************************************************
* Function Name: LowFrequencies_2_3_Stop
********************************************************************************
*
* Summary:
...
void LowFrequencies_2_3_Stop(void) 
{
	...
	#if(LowFrequencies_2_3_CLOCK_SRC == LowFrequencies_2_3_CLOCK_INT)  	
	   LowFrequencies_2_3_DacClk_Stop();
	#endif /* LowFrequencies_2_3_CLOCK_SRC == LowFrequencies_2_3_CLOCK_INT */
	
	/* Disble DMA channels */
	(void)CyDmaChDisable(LowFrequencies_2_3_Wave1Chan);
	(void)CyDmaChDisable(LowFrequencies_2_3_Wave2Chan);
...
/*******************************************************************************
* Function Name: LowFrequencies_2_3_Wave1Setup
********************************************************************************
*
* Summary:
...

{
		...
		memoryType = (LowFrequencies_2_3_HI16FLASHPTR == HI16(wavePtr)) ? HI16(CYDEV_FLS_BASE) : HI16(CYDEV_SRAM_BASE);
		
		LowFrequencies_2_3_Wave1Chan = LowFrequencies_2_3_Wave1_DMA_DmaInitialize(
		LowFrequencies_2_3_Wave1_DMA_BYTES_PER_BURST, LowFrequencies_2_3_Wave1_DMA_REQUEST_PER_BURST,
		memoryType, HI16(CYDEV_PERIPH_BASE));
	#else /* PSoC 5 */
		LowFrequencies_2_3_Wave1Chan = LowFrequencies_2_3_Wave1_DMA_DmaInitialize(
		LowFrequencies_2_3_Wave1_DMA_BYTES_PER_BURST, LowFrequencies_2_3_Wave1_DMA_REQUEST_PER_BURST,
		HI16(wavePtr), HI16(LowFrequencies_2_3_DAC8__D));
	#endif /* CY_PSOC3 */
	...
	*/
	(void)CyDmaTdSetConfiguration(LowFrequencies_2_3_Wave1TD, sampleSize, LowFrequencies_2_3_Wave1TD, 
                                    (uint8)CY_DMA_TD_INC_SRC_ADR | (uint8)LowFrequencies_2_3_Wave1_DMA__TD_TERMOUT_EN); 
	
	/* Set the TD source and destination address */
	(void)CyDmaTdSetAddress(LowFrequencies_2_3_Wave1TD, LO16((uint32)wavePtr), LO16(LowFrequencies_2_3_DAC8__D));
	
	/* Associate the TD with the channel */
	(void)CyDmaChSetInitialTd(LowFrequencies_2_3_Wave1Chan, LowFrequencies_2_3_Wave1TD);
}


/*******************************************************************************
* Function Name: LowFrequencies_2_3_Wave2Setup
********************************************************************************
*
* Summary:
 ...
 
{
		...
		LowFrequencies_2_3_Wave2Chan = LowFrequencies_2_3_Wave2_DMA_DmaInitialize(
		LowFrequencies_2_3_Wave2_DMA_BYTES_PER_BURST, LowFrequencies_2_3_Wave2_DMA_REQUEST_PER_BURST,
		memoryType, HI16(CYDEV_PERIPH_BASE));
	#else /* PSoC 5 */
		LowFrequencies_2_3_Wave2Chan = LowFrequencies_2_3_Wave2_DMA_DmaInitialize(
		LowFrequencies_2_3_Wave2_DMA_BYTES_PER_BURST, LowFrequencies_2_3_Wave2_DMA_REQUEST_PER_BURST,
	...
	* Increment the source address, but not the destination address. 
	*/
	(void)CyDmaTdSetConfiguration(LowFrequencies_2_3_Wave2TD, sampleSize, LowFrequencies_2_3_Wave2TD, 
                                    (uint8)CY_DMA_TD_INC_SRC_ADR | (uint8)LowFrequencies_2_3_Wave2_DMA__TD_TERMOUT_EN); 
	
	/* Set the TD source and destination address */
	(void)CyDmaTdSetAddress(LowFrequencies_2_3_Wave2TD, LO16((uint32)wavePtr), LO16(LowFrequencies_2_3_DAC8__D));
	
	/* Associate the TD with the channel */
	(void)CyDmaChSetInitialTd(LowFrequencies_2_3_Wave2Chan, LowFrequencies_2_3_Wave2TD);
}
